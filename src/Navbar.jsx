        ...
        <>
            <nav className="navbar navbar-expand-lg bg-light sticky-top scrolled">
                <div className="container-fluid">
                    ...
                    <span className='toggle' type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling"><i className="bi bi-text-left"></i></span>
