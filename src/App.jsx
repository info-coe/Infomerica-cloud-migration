...
function App() {
  return (
    <>
      ...
      <div className="mt-4">
        <h1 className="text-center" style={{ color: "#FE0000" }}>
          AWS Competency – Our Approach
        </h1>
        <div>
          ...
          <div className="d-flex gap-3 m-4 fs-6">
      ...
      <div className="m-5">
        <h1 style={{ color: "#FE0000" }}>Our AWS Service Portfolio</h1>
        <p className="fs-5">
      ...
      <div className="m-5">
        <h1 style={{ color: "#FE0000" }}>Migration Services</h1>
        <p className="fs-5">
        ...
        <div className="fs-5">
          <p>
            <b>Assess: </b>Infomerica initiates the migration journey with a
            thorough Migration Readiness Assessment (MRA) aligned ​with the AWS
            Cloud Adoption Framework. This assessment evaluates the enterprise's
            cloud readiness and ​provides an action plan to address identified
            gaps.
          </p>
          <p>
            <b>Mobilise: </b>Infomerica builds AWS proficiency within client
            organizations by facilitating hands-on migration ​experiences. This
            phase focuses on establishing a scalable and secure AWS landing zone
            while migrating select ​business applications to the cloud.
          </p>
          <p>
            <b>Migrate & Modernise: </b>A significant portion (20-50%) of an
            enterprise application portfolio comprises repeated ​patterns that
            can be optimized through a factory approach. So, we're working with
            you to set up a Migration Factory ​using patterns, processes, tools,
            resources, and methodologies defined and tested during the
            mobilization phase to ​migrate applications at scale. Larger and
            more complex applications often follow the refactor/rearchitect
            pattern, ​and Infomerica's Architects, Cloud Specialists, and SecOps
            Specialists work diligently to ensure your success in ​migrating to
            AWS.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          ...
          <div className="m-5">
            <div>
              <h5>Discovery, Planning, and Recommendation:</h5>
              <p>
                Infomerica assists in assessing your existing environment,
                identifying workloads suitable for migration, and recommending
                the best approach. Our expertise ensures faster and automated
                application portfolio assessments, cutting down weeks of effort
                needed for modernization assessments.
              </p>
            </div>
            <div>
              <h5>Business Case Analysis:</h5>
              <p>
                Infomerica helps build a compelling business case for
                application modernization. For legacy workloads on AWS,
                automated analysis with containers and serverless tech is
                provided.
              </p>
            </div>
            <div>
              <h5>Application Mobility:</h5>
              <p>
                Infomerica offers tools for automated re-platforming,
                refactoring, and augmented refactoring by developers. Our
                services enable seamless migration and modernization of
                applications.
              </p>
            </div>
            <div>
            ...
            <div>
              <h5>App monitoring & composition:</h5>
              <p>
      ...
      <div className="d-lg-flex bg-light">
        ...
        <div className="col-lg-6">
          <h4 className="text-center pt-4">Contact Us</h4>
          <hr className="text-danger w-75 footerHr" />
          <div className="p-lg-4 p-3 d-flex gap-5">
            <div className="fs-3">
              <i className="bi bi-telephone-fill"></i>
            </div>
            <div>
              <h4>PHONE</h4>
              <h4>+1 919-655-0800</h4>
            </div>
          </div>
          <div className="p-lg-4 p-3 d-flex gap-5">
            <div className="fs-3">
            ...
            <div>
              <h4>EMAIL</h4>
              <h4>
                <a href="mailto:info@infomericainc.com" className="text-dark">
          ...
          <div className="p-3 d-flex gap-5">
            ...
            <div className="d-flex gap-4">
              <div className="text-danger bg-danger fs-2 text-light ps-2 pe-2 rounded">
                <a
                  href="https://www.youtube.com/@infomericainc522"
              ...
              <div className="text-info fs-2 bg-info ps-2 pe-2 rounded text-light">
                <a
                  href="https://www.linkedin.com/company/infomerica/"
                  className="text-decoration-none text-light"
                  target="blank"
                >
              ...
              <div className="text-primary fs-2 bg-primary ps-2 pe-2 rounded text-light">
                <a
                  href="https://www.facebook.com/Infomerica1998/"
                  className="text-decoration-none text-light"
                  target="blank"
                >
